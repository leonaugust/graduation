...
public class RestaurantTestData {
    ...
    public static final Restaurant KRUSTY_KRAB = new Restaurant(KRUSTY_KRAB_ID, "The Krusty Krab ");


    public static final List<Restaurant> RESTAURANTS = List.of(GUSTEAUS, PIZZA_PLANET, KRUSTY_KRAB);
